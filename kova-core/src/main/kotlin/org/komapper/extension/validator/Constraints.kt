...
object Constraints {
    ...
    ): context(ValidationContext) (T) -> ConstraintResult = {
    ...
    fun <T : Any> isNull(message: MessageProvider0<T?>): context(ValidationContext) (T?) -> ConstraintResult = {
        satisfies(it == null, message(it))
    }

    fun <T : Any> notNull(message: MessageProvider0<T?>): context(ValidationContext) (T?) -> ConstraintResult = {
        satisfies(it != null, message(it))
    }
}
